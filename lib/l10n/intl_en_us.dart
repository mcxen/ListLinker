const translationsEnUS = {
  ...
  "localVideos_emptyHint": "Choose videos from your gallery or files to play them with the built-in player.",
  "localVideos_pickFailed": "Failed to pick video",
  "localVideos_noVideoSelected": "No video files selected",
  "smb_emptyHint": "Add an SMB/CIFS share to browse and play videos on your network.",
  ...
  "smb_scanHint": "Scans your local network for devices with SMB (port 445). This may take about a minute.",
