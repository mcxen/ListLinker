      ...
      onTap: () {
        switch (settingsMenu.menuId) {
          ...
          case MenuId.privacyPolicy:
            ...
            final url =
                "https://${Global.configServerHost}/listlinker_h5/privacyPolicy?version=${packageInfo?.version ?? ""}&lang=$local";
            Log.d("url:$url");
            Get.toNamed(
              NamedRouter.web,
              arguments: {
          ...
          case MenuId.about:
            ...
            final url =
                "https://${Global.configServerHost}/listlinker_h5/declaration?version=${packageInfo?.version ?? ""}&lang=$local";
            Log.d("url:$url");
            Get.toNamed(
              NamedRouter.web,
